...
<body>
  ...
  <script>
    ...
    function getWeather() {
      ...
      xhr.open(
        "GET",
        "http://api.openweathermap.org/data/2.5/weather?id=1214520&units=metric&appid=fd6c59cfa472a8195c8f31ae0d68b6b7"
      );
      xhr.onload = () => {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
        ...
        html.push(`<div class="bookmark-title">Ilmu Komputer Laboratory Center.</div>`);
